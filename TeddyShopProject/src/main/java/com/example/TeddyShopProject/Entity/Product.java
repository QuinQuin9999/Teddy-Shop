...
public class Product {
    ...
    public Product(String _id, String productName, String productType, String productImg, Map<String, Double> productPrice, int discount, Map<String, Map<String, Integer>> countInStock, Map<String, ArrayList<String>> description) {
        this._id = _id;
